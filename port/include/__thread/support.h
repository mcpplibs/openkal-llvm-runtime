...
//
// ALL THREE BRANCHES ARE FINE FOR openkal EXCEPT THE FIRST, WHICH IS THE ONE
...
//
// AND IT CANNOT BE SWITCHED OFF. `_LIBCPP_HAS_THREAD_API_PTHREAD` is ours to
...
//
// THAT IS THE WHOLE CONTRACT AT THIS CALL SITE. The identity is used to
